...
| Bitcoin tab | On-chain resets (Puell, MVRV, ThermoCap, exchange flows), the cycle clock, the Mayer multiple, the 200-week average, a log regression position, stablecoin supply, dominance and attention (both unscored), funding, trend rules, Pi Cycle; app rank, whale cohorts and ETF flows have no free feed | Coin Metrics community API, DefiLlama, CoinGecko, Wikimedia, Bybit or OKX or Hyperliquid, blockchain.com (fallback) | Daily | v5 |
