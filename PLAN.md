...
| Bitcoin tab | On-chain resets (Puell, MVRV, ThermoCap, exchange flows), the cycle clock, stablecoin supply, dominance (logged), funding, trend rules, Pi Cycle; search, app rank, whale cohorts and ETF flows have no free feed | Coin Metrics community API, DefiLlama, CoinGecko, Bybit, blockchain.com (fallback) | Daily | v5 |
